...
export default function Profile() {
  ...
  const completionPct = fullProfile ? computeProfileCompletion(fullProfile) : 0;
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-grow max-w-3xl w-full mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="bg-card rounded-2xl p-4 border border-border/50 shadow-sm mb-6">
          <h2 className="text-sm font-semibold text-foreground mb-2">Why this matters</h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm">
            <div className="rounded-2xl border border-border bg-background px-4 py-3">
              <p className="font-semibold text-foreground">Trust</p>
              <p className="mt-1 text-muted-foreground">Owners respond better when your move-in date, budget, and occupation are clear.</p>
            </div>
            <div className="rounded-2xl border border-border bg-background px-4 py-3">
              <p className="font-semibold text-foreground">Matching</p>
              <p className="mt-1 text-muted-foreground">Lifestyle details help SakanMatch explain why a room or roommate is a good fit.</p>
            </div>
            <div className="rounded-2xl border border-border bg-background px-4 py-3">
              <p className="font-semibold text-foreground">Conversion</p>
              <p className="mt-1 text-muted-foreground">A complete profile makes your request feel more serious than a cold message.</p>
            </div>
          </div>
        </div>
