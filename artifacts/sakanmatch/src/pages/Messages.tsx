  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-grow max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-4 rounded-2xl border border-amber-200 bg-amber-50 px-4 py-4 text-sm text-muted-foreground dark:border-amber-900/60 dark:bg-amber-950/20">
