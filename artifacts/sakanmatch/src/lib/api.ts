...
export const api = {
  ...
  reportListing: (listingId: number, data: ReportPayload) =>
    apiFetch(`/reports/listings/${listingId}`, { method: "POST", body: JSON.stringify(data) }),
  reportUser: (userId: number, data: ReportPayload) =>
    apiFetch(`/reports/users/${userId}`, { method: "POST", body: JSON.stringify(data) }),
